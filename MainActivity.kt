    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        newgame.setOnClickListener {
            ...
            fun generateRandomCoordinates() {
                val randomX = random.nextInt(801) - 400 // Correct range: -400 to 400
                val randomY = random.nextInt(801) - 400 // Correct range: -400 to 400
                meat.x =randomX.toFloat()
                meat.y = randomY.toFloat()
            }

            generateRandomCoordinates() // Call to place meat initially
